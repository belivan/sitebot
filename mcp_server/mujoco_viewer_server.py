    ...
    def handle_command(self, command: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            if cmd_type == "load_model":
                ...
                with self.current_viewer.viewer.lock():
                    for i, val in enumerate(control[: self.current_viewer.model.nu]):
                        self.current_viewer.data.ctrl[i] = val
                return {"success": True, "control_set": control}
                ...
                with self.current_viewer.viewer.lock():
                    ...
                    for i in range(model.nsensor):
                        ...
                        if name:
                            ...
                            sensor_data[name] = data.sensordata[adr : adr + dim].tolist()
